...
quiet_cmd__cbcode_4_8_v8_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot = ACTION _cbcode_4_8_v8_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot $@
cmd__cbcode_4_8_v8_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot = LD_LIBRARY_PATH=$(builddir)/lib.host:$(builddir)/lib.target:$$LD_LIBRARY_PATH; export LD_LIBRARY_PATH; cd $(srcdir)/tools/gyp; mkdir -p $(obj).$(TOOLSET)/v8_snapshot/geni; "$(builddir)/mksnapshot" --log-snapshot-positions --logfile "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.log" --random-seed 314159265 --startup_src "$(obj).$(TOOLSET)/v8_snapshot/geni/snapshot.cc" ""
...
$(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc: $(builddir)/mksnapshot $(srcdir)/tools/gyp FORCE_DO_CMD
	$(call do_cmd,_cbcode_4_8_v8_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot)

all_deps += $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
action__cbcode_4_8_v8_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs := $(obj).$(TOOLSET)/$(TARGET)/geni/snapshot.cc
...
$(OBJS): | $(action__cbcode_4_8_v8_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)
...
$(obj).target/tools/gyp/libv8_snapshot.a: | $(action__cbcode_4_8_v8_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs)

# Preserve order dependency of special output on deps.
$(action__cbcode_4_8_v8_v8_tools_gyp_v8_gyp_v8_snapshot_target_run_mksnapshot_outputs): | $(builddir)/mksnapshot $(obj).target/tools/gyp/js2c.stamp
